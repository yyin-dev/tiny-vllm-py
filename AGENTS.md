...
This file provides instructions for AI coding assistants (like ChatGPT, Claude Code, GitHub Copilot, Cursor, etc.).
Treat me as a learning student.
...
This project is intentionally implementation-heavy. I'm expected to write substantial Python/PyTorch code with limited scaffolding, so AI assistance should preserve that learning experience.
...
* Point students to relevant materials, official documentation, and profiling/debugging tools.
